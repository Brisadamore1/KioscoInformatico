...
namespace KioscoInformatico.Migrations
{
    ...
    [Migration("20240828193914_agregamosDetalleCompra")]
    partial class agregamosDetalleCompra
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KioscoInformatico.Models.Compra", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KioscoInformatico.Models.Venta", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClienteId = 1,
                            Fecha = new DateTime(2024, 8, 28, 16, 39, 12, 906, DateTimeKind.Local).AddTicks(9467),
                            FormaPago = 1,
                            Iva = 21m,
                            Total = 3000m
                        },
                        new
                        {
                            Id = 2,
                            ClienteId = 2,
                            Fecha = new DateTime(2024, 8, 28, 16, 39, 12, 906, DateTimeKind.Local).AddTicks(9473),
                            FormaPago = 4,
                            Iva = 10m,
                            Total = 5000m
                        },
                        new
                        {
                            Id = 3,
                            ClienteId = 3,
                            Fecha = new DateTime(2024, 8, 28, 16, 39, 12, 906, DateTimeKind.Local).AddTicks(9477),
                            FormaPago = 3,
                            Iva = 21m,
                            Total = 8000m
                        });
            ...
            modelBuilder.Entity("KioscoInformatico.Models.Compra", b =>
                {
                    b.HasOne("KioscoInformatico.Models.Proveedor", "Proveedor")
                        .WithMany()
            ...
            modelBuilder.Entity("KioscoInformatico.Models.Venta", b =>
                {
                    b.HasOne("KioscoInformatico.Models.Cliente", "cliente")
                        .WithMany()
